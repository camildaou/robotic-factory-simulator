...
public class Position implements Serializable {
	 ...
	 * @return The Manhattan distance (sum of absolute differences in x and y)
	 */
	public int distanceTo(final Position other) {
		if (other == null) {
			return Integer.MAX_VALUE;
		}
		return Math.abs(this.xCoordinate - other.getxCoordinate()) + 
		       Math.abs(this.yCoordinate - other.getyCoordinate());
	}
}
